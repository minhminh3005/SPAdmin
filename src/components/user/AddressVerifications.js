...
import UserAddressVerificationModal from "./UserAddressVerificationModal";
import { copyToClipboard } from "../../utils/util";

function AddressVerifications({ data, onReload }) {
...
export default SearchHigherComponent(AddressVerifications, {
  endpoint: `/user-service/address-verification/list`,
